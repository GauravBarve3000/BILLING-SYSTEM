...
class Bill_App:
    def __init__(self, root):
        ...
        self.jeans=["ZARA","Levis","ARMANI","GUCCI"]
        self.price_zara=25000
        self.price_levis=5000
        self.price_armani=9000
        ...
        # SubCatMobiles
        self.SubCatMobiles=["IPhone","Samsung","Realme","POCO","OnePlus"]
        ...
        self.POCO=[ 'POCOM2', 'POCOM3', 'POCOM3 Pro']
        self.price_m2=9000
        self.price_m3=11000
        self.price_m3pro=12000

        self.OnePlus=['OnePlus 9', 'OnePlus 9Pro', 'OnePlus 8T']
        self.price_one9=45000
        self.price_one_9pro=60000
        ...
        # Sub-Category
        self.lblSubCategory=Label(Product_Frame,font=('arial',12,'bold'),bg="white",text="Subcateory",bd=4)
        ...
        self.ComboPrice.grid(row=0, column=3, sticky=W, padx=4, pady=2)
        ...
        self.Combo_Qty.grid(row=1, column=3, sticky=W, padx=4, pady=2)
        ...
        lbl_mid_img=Label(MiddleFrame,image=self.photomid_img)
        ...
        lbl_mid_img_1.place(x=490,y=0,width=500,height=340)
        ...
        self.Entry_Qty=ttk.Entry(Bottom_Frame, font=('arial', 10, 'bold'), width=26)
        self.Entry_Qty.grid(row=0, column=1, sticky=W, padx=4, pady=2)
    ...
    def AddItem(self):
        ...
        if self.product.get()=="":
            ...
            self.sub_total.set(str('Rs.%.2f'%(sum(self.lst))))
            self.tax_input.set(str('Rs.%.2f'%(((sum(self.lst)) - (self.prices.get())) * Tax)/100))
            self.total.set(str("Rs.%.2f"%(((sum(self.lst)) + (((sum(self.lst)) - (self.prices.get() * Tax) / 100))))))
    ...
    def welcome(self):
        ...
        self.textarea.insert(END,"\t\t\tWelcome TO D-Mart")
    ...
    def price(self,event=""):
        ...
        if self.ComboProduct.get()=="Samsung M16":
            self.ComboPrice.config(value=self.price_sml6)
            self.ComboPrice.current(0)
            self.qty.set(1)
        ...
        # POCO
        if self.ComboProduct.get()=="POCOM2":
            self.ComboPrice.config(value=self.price_m2)
            self.ComboPrice.current(0)
            self.qty.set(1)

        if self.ComboProduct.get()=="POCOM3":
            self.ComboPrice.config(value=self.price_m3)
            self.ComboPrice.current(0)
            self.qty.set(1)

        if self.ComboProduct.get()=="POCOM3 Pro":
            self.ComboPrice.config(value=self.price_m3pro)
            self.ComboPrice.current(0)
            self.qty.set(1)
        ...
        if self.ComboProduct.get()=="OnePlus 9Pro":
            self.ComboPrice.config(value=self.price_one_9pro)
            self.ComboPrice.current(0)
            self.qty.set(1)

        if self.ComboProduct.get()=="OnePlus 8T":
            self.ComboPrice.config(value=self.price_one_8t)
            self.ComboPrice.current(0)
            self.qty.set(1)
